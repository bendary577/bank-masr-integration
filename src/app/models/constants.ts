...
export class Constants {
  ...
  static GET_POS_SALES_API_DAILY_URL =
    environment.apiHost + "/salesAPI/getPOSSales";
  ...
  static FORGET_PASSWORD_PAGE = "forgetPassword";
  static RESET_PASSWORD_PAGE = "resetPassword";
  ...
  static GET_VOUCHER_BY_ID =
    environment.apiHost + "/simphonyLoyalty/vouchers/getByID";
  static ADD_VOUCHER_PAGES =
    environment.apiHost + "/simphonyLoyalty/vouchers/add";
  static UPDATE_VOUCHER_PAGES =
    environment.apiHost + "/simphonyLoyalty/vouchers/update";
  static MARK_VOUCHER_DELETE_PAGES =
    environment.apiHost + "/simphonyLoyalty/vouchers/markDeleted";
  static GET_VOUCHER_TRANSACTION_PAGES =
    environment.apiHost +
    "/simphonyLoyalty/voucherTransactions/getTotalVoucherTrans";
  static GET_VOUCHER_TRANSACTION_STATISTICS =
    environment.apiHost +
    "/simphonyLoyalty/voucherTransactions/getVoucherTransStatistics";
  ...
  static EXPORT_VOUCHER_CODE_PDF =
    environment.apiHost + "/simphonyLoyalty/vouchers/exportCodePDF";
