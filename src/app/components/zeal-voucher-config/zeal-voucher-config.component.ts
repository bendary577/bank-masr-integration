...
@Component({
  selector: 'app-zeal-voucher-config',
  templateUrl: './zeal-voucher-config.component.html',
  styleUrls: ['./zeal-voucher-config.component.scss']
})
export class ZealVoucherConfigComponent implements OnInit {
  loading = true;
