...
@Component({
  selector: 'app-canteen-add-app-user-accompied-component',
  templateUrl: './canteen-add-app-user-accompied-component.component.html',
  styleUrls: ['./canteen-add-app-user-accompied-component.component.scss']
})
export class CanteenAddAppUserAccompiedComponentComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, public snackBar: MatSnackBar, 
    public dialogRef: MatDialogRef<CanteenAddAppUserAccompiedComponentComponent>, 
