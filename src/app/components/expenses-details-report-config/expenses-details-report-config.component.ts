...
@Component({
  selector: 'app-expenses-details-report-config',
  templateUrl: './expenses-details-report-config.component.html',
  styleUrls: ['./expenses-details-report-config.component.scss']
})
