...
@Component({
  selector: 'app-canteen-user-profile-component',
  templateUrl: './canteen-user-profile-component.component.html',
  styleUrls: ['./canteen-user-profile-component.component.scss']
})
export class CanteenUserProfileComponentComponent implements OnInit {
