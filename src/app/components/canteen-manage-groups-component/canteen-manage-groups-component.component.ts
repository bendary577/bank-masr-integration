...
@Component({
  selector: 'app-canteen-manage-groups-component',
  templateUrl: './canteen-manage-groups-component.component.html',
  styleUrls: ['./canteen-manage-groups-component.component.scss']
})
export class CanteenManageGroupsComponentComponent implements OnInit {
