...
@Component({
  ...
  templateUrl: './sales-api-monthly-config.component.html',
  styleUrls: ['./sales-api-monthly-config.component.scss']
})
export class SalesApiMonthlyConfigComponent implements OnInit {
  ...
  getSyncJobType() {
    this.loading = true;
    this.accSyncTypeService.getAccSyncJobType(Constants.POS_SALES_API_MONTHLY_SYNC).toPromise().then((res: any) => {
