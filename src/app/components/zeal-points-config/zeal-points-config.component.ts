...
@Component({
  selector: 'app-zeal-points-config',
  templateUrl: './zeal-points-config.component.html',
  styleUrls: ['./zeal-points-config.component.scss']
})
export class ZealPointsConfigComponent implements OnInit {
  loading = true;
